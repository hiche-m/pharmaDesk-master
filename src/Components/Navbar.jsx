...
const Navbar = () => {
    ...
    return (<div className="col-span-9 row-span-1 inline-flex items-center justify-start text-base font-medium text-textSecoundary py-5 px-4 space-x-4 border-b-2 border-lightShapes">
