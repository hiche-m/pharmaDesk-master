...
const TailwindConfirmModal = ({ title, content, actionLabel = 'Continuer', cancelLabel = 'Annuler', actionFunction, cancelAction }) => {
                ...
                <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                    <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                        <div className="sm:flex sm:items-start">
                            <div className={`mx-auto flex size-12 shrink-0 items-center justify-center rounded-full bg-opacity-10 bg-red-600 sm:mx-0 sm:size-10`}>
                    ...
                    <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                        <button type="button" className={`inline-flex w-full justify-center rounded-md bg-red-600 bg-opacity-90 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-opacity-100 sm:ml-3 sm:w-auto`} onClick={() => actionFunction()}>{actionLabel}</button>
